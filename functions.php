...
function bootstrap2wordpress_scripts() {
	...
	wp_enqueue_script( 'bootstrap2wordpress-bootstrap', get_template_directory_uri() . '/js/bootstrap.min.js', array(), false, true );

	//wp_enqueue_script( 'bootstrap2wordpress-jquery', get_template_directory_uri() . '/js/jquery-3.4.1.min.js', array(), false, true );
